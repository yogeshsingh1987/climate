    ...
    <>
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="grid grid-cols-[10%_20%_45%_20%] gap-5 4444">
          ...
          <div className="rwerwe">
            <div className="flex flex-row h-24 w-[100%] bg-[#000] border-2 border-b-0 border-[#FFFFFF]">
            ...
            <table className=" w-[100%] productInfoBox">
              ...
              {tableBarChart.map((chart) => {
                return (
                  <div className="w-[250px] infoBox">
                    <span className="font-semibold text-center my-4">
                      {chart.head}
                    </span>
                    <BarChart
                      indexAxis="y"
